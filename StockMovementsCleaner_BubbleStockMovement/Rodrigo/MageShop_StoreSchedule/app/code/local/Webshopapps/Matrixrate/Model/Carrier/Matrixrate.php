    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        // Instancia o Helper do módulo StoreSchedule
        $helper = Mage::helper('storeschedule');
        // Chama o método isDeliveryAvailabre, que verifica se o delivery está disponível
        $deliveryAvailable = $helper->isDeliveryAvailable();

        // Se estiver indisponível não carrega a Matrixrate
